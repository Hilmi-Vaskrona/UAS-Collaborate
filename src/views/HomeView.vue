...
<div class="w-full min-h-[90vh] flex items-center justify-center">
  ...
  <div v-if="url === 'Destination'">
    <DestinasiKomponen />
  </div>
  <div v-if="url === 'Packages'">
    <PaketKomponen />
  </div>
  <div v-if="url == 'Account'">
    <AkunKomponen />
  </div>
</div>
...
import TrustedPartnerSection from '@/components/sections/TrustedPartnerSection.vue'
import PerfectTripSection from '@/components/sections/PerfectTripSection.vue'
import TripPlanningSection from '@/components/sections/TripPlanningSection.vue'
import WhySafariSection from '@/components/sections/WhySafariSection.vue'
